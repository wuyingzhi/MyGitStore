...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fUpdSelect(-1,-1,-1))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Clear</A>";	// the content of the bottom section.
